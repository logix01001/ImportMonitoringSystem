...
class VESSELWAITINGExport implements FromCollection,WithHeadings,ShouldAutoSize
{
    /**
...
//{factory?}/{category?}/{reference?}/{pod?}/{date_request?}/{dateMonth?}/{dateYear?}/{start?}/{end?}
    ...
    public function collection()
    {
        ...
        $select = explode(",", $_ENV['SELECT_EXPORT']);
    ...
    {
        return explode(",", $_ENV['SELECT_EXPORT_HEADER']);
    }
