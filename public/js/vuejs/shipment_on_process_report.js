new Vue({
    ...
    methods: {
        ...
        searchDate(date = null,reference){
            ...
            axios.post(`http://${window.location.host}/${myBaseName}api/bill_of_lading/shipment_onprocess_report`,
            {
        ...
        showDetails(factory=null,category=null,pod=null,pod_all = false,factory_all = false){
            ...
            axios.post(`http://${window.location.host}/${myBaseName}api/bill_of_lading/shipment_onprocess_report_details`,
            {
