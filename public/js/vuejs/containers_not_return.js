new Vue({
    ...
    methods: {
        ...
        searchDate(date = null,reference,as_of_now = false){
            ...
            axios.post(`http://${window.location.host}/${myBaseName}api/bill_of_lading/containers_not_return`,
            {
        ...
        showDetails(factory=null,factory_all = false){
            ...
            axios.post(`http://${window.location.host}/${myBaseName}api/bill_of_lading/containers_not_return_details`,
            {
