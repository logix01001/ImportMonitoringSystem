new Vue({
    ...
    methods: {
        ...
        searchDate(date = null,reference,as_of_now = false){
            ...
            axios.post(`http://${window.location.host}/${myBaseName}api/bill_of_lading/onhand_gatepass`,
            {
        ...
        showDetails(factory=null,category=null,pod=null,pod_all = false,factory_all = false){
            ...
            axios.post(`http://${window.location.host}/${myBaseName}api/bill_of_lading/onhand_gatepass_details`,
            {
