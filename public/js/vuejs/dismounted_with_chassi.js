new Vue({
    ...
    methods: {
        ...
        searchDate(date = null,reference){
            var self = this
            $.blockUI({ message: '<h3> Processing ...</h3>' }); 

            axios.post(`http://${window.location.host}/${myBaseName}api/bill_of_lading/dismounted_with_chassi`,
            {
        ...
        showDetails(factory=null,category=null,cy=null,cy_all = false,factory_all = false){
            var self = this
            ...
            axios.post(`http://${window.location.host}/${myBaseName}api/bill_of_lading/dismounted_with_chassi_details`,
            {
