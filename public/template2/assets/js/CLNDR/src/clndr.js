...
(function (factory) {
    ...
    var clndrTemplate =
        "<div class='clndr-controls'>" +
            "<div class='clndr-control-button'  data-month='<%= month %>' data-year='<%= year %>' id='prev'>" +
                "<span class='clndr-previous-button btn btn-primary'><i class='fa fa-arrow-left'></i> previous</span>" +
            "</div>" +
            "<div class='month'><h2> <%= month %> <%= year %> </h2></div>" +
            "<div class='clndr-control-button rightalign' id='next' data-month='<%= month %>' data-year='<%= year %>'>" +
                "<span class='clndr-next-button btn btn-primary'>next <i class='fa fa-arrow-right'></i></span>" +
            "</div>" +
        "</div>" +
