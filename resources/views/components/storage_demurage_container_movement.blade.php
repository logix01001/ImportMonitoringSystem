                            ...
                            <table class="table table-bordered table-bordered-dark fixTable2">
                                ...
                                <tbody style="font-size:15px">
                                    <tr v-for="(container,index2) in BOL.container_numbers">
                                        ...
                                        <td :class="container.quantity == 0 ? 'quadrat stickycolumn' : 'stickycolumn'"
                                            @dblclick="splitBL_NO(container.id,container.split_bl_no_fk,container.quantity)"><span
                                                :style="container.xray == 1? {'color':'red'}:{}">@{{container.container_number}}</span></td>
                                        ...
                                        <td>
                                            ...
                                            <span v-show="!view_mode">
                                                <textarea @blur="saveValidation(container.id,'trucker',container.trucker)"
                                                    type="text" class="form-control" v-model="container.trucker" @input="container.trucker = $event.target.value.toUpperCase()">
                                                    </textarea>
                                            </span> --}}
                                        </td>
                                        <td>
