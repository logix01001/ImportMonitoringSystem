    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                    ...
                    @component('components.cleared_shipment')
                    @endcomponent
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                                ...
                                <button :disabled="showprogress" class="btn btn-primary btn-block m-t" @click="getRecord_Cleared(numberofTake)"><i
...
@section('vuejsscript')
    <script src="{{asset('/js/vuejs/cleared_shipment.js')}}"></script>
@endsection
