    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                    ...
                    @component('components.documentation_process')
                    @endcomponent
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                                ...
                                <button :disabled="showprogress" class="btn btn-primary btn-block m-t" @click="getRecord_e2m(numberofTake)"><i
...
@section('vuejsscript')
    <script src="{{asset('/js/vuejs/documentation_process.js')}}"></script>
@endsection
