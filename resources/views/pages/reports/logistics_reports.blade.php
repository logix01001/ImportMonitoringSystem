                ...
                <div class="ibox-content">
                   <div class="row">
                       <div class="col-md-4">
                            ...
                            <hr class="style-one">
                            <button 
                            :disabled="(!vessel || (!ETA && !ATA && !ATB)) && !port && !gatepass && !delivery && !unloaded && !returned"
                            class="btn btn-primary btn-block"
                            @click="filterDate">Filter</button>
                       </div>
                       <div class="col-md-4">
                           <div class="row">
                                <input type="checkbox" v-model="vessel" > On Vessel    
                                <div class="pull-right" style="margin-right:20%" v-show="vessel">

                                    <input type="checkbox" :disabled="!vessel"  v-model="ETA" > Est Time Arrival 
                                    <input type="checkbox" :disabled="!vessel"  v-model="ATA" > Act Time Arrival
                                    <input type="checkbox" :disabled="!vessel"  v-model="ATB" > Act Time Berthed 
                                    
                                </div>
                                <hr class="style-one">
                                <input type="checkbox" v-model="port"> At the port  (ATD)
                                <hr class="style-one">
                                <input type="checkbox" v-model="gatepass"> Gatepass  (Actual Gatepass)
                       ...
                       <div class="col-md-4">
                            <div class="row">
                                 ...
                                 <input type="checkbox" v-model="delivery"> Delivery  (Actual Delivery)
                                 <hr class="style-one">
                                 <input type="checkbox" v-model="unloaded"> Unloaded (Actual Unloaded)
                                 <hr class="style-one">
                                 <input type="checkbox" v-model="returned"> Return Empty (Date of returned)
                             </div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                        ...
                        <div class="row" style="text-align:center">
                            ...
                            <div v-if="list_of_BOL.length > 0 ">
                                    Total BL Records
                                     <h3 class="filterText" @click="filterOff('showingRecords')">@{{ list_of_BOL.length }}</h3>
                            </div>   
                        </div>
                       
                        <hr class="style-one">
                        <a v-if="list_of_BOL.length > 0" :href="'../extract_logistics_reports/' + last_vessel  + '/' + last_ETA  + '/' + last_ATA + '/' + last_ATB  + '/' + last_port + '/' + last_gatepass + '/'+ last_delivery + '/' + last_unloaded + '/' + last_returned + '/' + last_range_start + '/' + last_range_end" class="btn btn-primary btn-outline btn-dim pull-right"> Download CSV <i class="fa fa-2x fa-file-excel"></i> <i class="fa fa-2x fa-download"></i> </a>
...
@section('vuejsscript')
    <script src="{{asset('/js/vuejs/logistics_reports.js')}}"></script>
@endsection
