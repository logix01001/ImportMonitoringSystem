    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Shipment without gatepass</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-offset-6 col-lg-offset-6">
                                <a v-if="details_obj.length > 0" :href="'extract_shipment_without_gatepass/' + factory  + '/' + last_reference  + '/' + pod + '/' + date_filter  + '/' + dateMonth + '/' + dateYear + '/'+ range_start + '/' + range_end + '/' + as_of_now " class="btn btn-primary btn-outline btn-dim pull-right"> Download CSV <i class="fa fa-2x fa-file-excel"></i> <i class="fa fa-2x fa-download"></i> </a>
                        </div>        
                    </div>
...
@section('vuejsscript')
    ...
    <script src="{{asset('/js/vuejs/shipment_without_gatepass.js')}}"></script>
